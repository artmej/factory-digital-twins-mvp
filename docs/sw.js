const CACHE_NAME = 'smart-factory-v2.1';
const STATIC_CACHE = 'smart-factory-static-v2.1';
const DYNAMIC_CACHE = 'smart-factory-dynamic-v2.1';

const urlsToCache = [
  '/',
  '/dashboard.html',
  '/maintenance-calendar.html',
  '/executive-roi-dashboard-en.html',
  '/factory-3d.js',
  '/manifest.json',
  // External resources
...
self.addEventListener('install', (event) => {
  console.log('🚀 Service Worker: Installing Smart Factory PWA...');
  event.waitUntil(
    caches.open(STATIC_CACHE)
      .then((cache) => {
        console.log('📦 Service Worker: Caching Smart Factory resources');
        return cache.addAll(urlsToCache);
      })
      .then(() => {
        console.log('✅ Service Worker: Smart Factory PWA installation complete');
